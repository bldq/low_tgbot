...
async def echo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await context.bot.send_message(chat_id=update.effective_chat.id, text=str(get_url(str(url))))
    except ValueError:
...
if __name__ == '__main__':
    application = ApplicationBuilder().token('5790080134:AAFgk-Njer82TZnaRq6cSVf43EuewRnBHnI').build()
